...
# Set the file uploads directory
app.config["FILE_UPLOADS"] = os.path.join("C:\\", "Users", "jatin", "Downloads", "Huffman_Coding-main-1", "Huffman_Coding-main", "uploads")
...
def decompress():
    if request.method == "GET":
        ...
        if len(up_file.filename) > 0:
            ...
            while True:
                if os.path.exists(os.path.join('uploads', '{}{}'.format(filename, ftype))):
